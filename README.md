MonoBundle is a simple small MonoGame library that adds a few essential modules, that almost any game would require, such as UI, event handling and input handling.
